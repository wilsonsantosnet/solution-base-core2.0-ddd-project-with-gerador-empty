...
export class ProgramService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: ProgramServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Program', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Program').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Program').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Program').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if ( model.programId != undefined) {
            return this.api.setResource('Program').put(model);
        }

        return this.api.setResource('Program').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Program').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Program').export(filters);
    }
}
