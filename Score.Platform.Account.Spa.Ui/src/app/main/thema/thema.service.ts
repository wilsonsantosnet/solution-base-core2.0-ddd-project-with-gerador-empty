...
@Injectable()
export class ThemaService extends ServiceBase {

    private _form : FormGroup;

    constructor(private api: ApiService<any>,private serviceFields: ThemaServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Thema', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Thema').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Thema').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Thema').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if ( model.themaId != undefined) {
            return this.api.setResource('Thema').put(model);
        }

        return this.api.setResource('Thema').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Thema').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Thema').export(filters);
    }
}
