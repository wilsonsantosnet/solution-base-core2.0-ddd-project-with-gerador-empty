...
export class TenantService extends ServiceBase {
    ...
    constructor(private api: ApiService<any>,private serviceFields: TenantServiceFields, private globalServiceCulture: GlobalServiceCulture, private mainService: MainService) {
    ...
    getInfosTranslated(culture: string) {
        return this.globalServiceCulture.getInfosTranslatedStrategy('Tenant', culture, this.getInfos(), []);
    }

    get(filters?: any): Observable<any> {
        return this.api.setResource('Tenant').get(filters);
    }

    getDataCustom(filters?: any): Observable<any> {
        return this.api.setResource('Tenant').getDataCustom(filters);
    }

    getDataListCustom(filters?: any): Observable<any> {
        return this.api.setResource('Tenant').getDataListCustom(filters);
    }

    save(model: any): Observable<any> {

        if ( model.tenantId != undefined) {
            return this.api.setResource('Tenant').put(model);
        }

        return this.api.setResource('Tenant').post(model);
    }

    delete(model: any): Observable<any> {
        return this.api.setResource('Tenant').delete(model);
    }
    
    export(filters?: any): Observable<any> {
        return this.api.setResource('Tenant').export(filters);
    }
}
